 ...
 */
export const ReadMusicXml = async (content: string): Promise<ScoreTimewise> => {
  const str: string = content;

  console.log("musicxml read", content.substring(0, 255));
  ...
  // Ajout Bludwarf
  throw new Error('Cannot read MusicXML')
}
